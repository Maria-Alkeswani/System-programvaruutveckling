...
//        System.out.println("Hello World!");
        ...
        while(test)
        {
            ...
            if(order.equals("1")) 
            {
                ...
                str=ord.nextLine();       //اسم الملف
                
                f_csv.csv_analysis(str);   //لفرز ملف المعطى بحسب العمر والجنس
                obj_table.final_table("table.csv",delay_time);         //لايجاد جدول الوقت لكل الفرق التي لدينا
                f_csv.sort_groups_and_games("Gamer_time\\","tables\\format_table.csv");  // لايجاد جدول الوقت لكل فريق على حدا
                print("Table created.\n\n");
                //-------------------------------------------------------------------------------------
                //لايجاد جدول الفاينال النهائي
            ...
            {
                obj_table.gamer_find();   // لطلب اسم الفريق ليتم طباعة جدول الوقت له
            }
